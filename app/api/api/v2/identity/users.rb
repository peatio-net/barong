      ...
      resource :users do
        ...
        namespace :email do
          ...
          post '/confirm_code' do
            ...
            Barong::EventAPI.notify('system.user.email.confirmed',
                            record: {
        ...
        namespace :password do
          ...
          post '/generate_code' do
            ...
            Barong::EventAPI.notify('system.user.password.reset.token',
                            record: {
                              user: current_user.as_json_for_event_api,
                              domain: Barong::App.config.domain,
                              url: Barong::App.url,
          ...
          post '/confirm_code' do
            ...
            Barong::EventAPI.notify('system.user.password.reset',
                            record: {
                              user: current_user.as_json_for_event_api,
                              domain: Barong::App.config.domain,
                              url: Barong::App.url
